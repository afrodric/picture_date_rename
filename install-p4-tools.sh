...
function do_p4runtime {
    ...
    # configure error invalid CXXFLAGS 
...
check_and_do ${FABRICP4_TEST_COMMIT} fabricp4-test do_faricp4_test fabricp4-test
echo "Done!"
